...
| `ogj/` | OGJ Worldwide Refining survey | worldwide, 577 | 2 | no | owner/city/status; country on every row; rebuilt from WW Refining PDF; **no coords** |
| `ogim/` | OGIM v2.7 refineries layer | worldwide, 692 | 2 | yes | GIS; coordinate/location corroboration |
