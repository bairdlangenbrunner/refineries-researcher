...
Rules baked in:
  - leading sheet mirrors the main rows in paths.SCHEMA column order, current values
...
SHEET_DESCRIPTIONS = {
    ...
    "main_mirror": "Rows to change, in schema order, SheetRow-keyed; overlays on touched cells.",
    "new_refineries": "Proposed new records (discovery/build).",
    "background_only": "Background-dataset rows not matched to the main — match to OtherNames first.",
